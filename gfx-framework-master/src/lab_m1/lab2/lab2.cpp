...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.5f, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5f, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0, 0.2f, 1)), // SUS !!!!!!!!
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0.5f, 1)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.4f, 1)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0.3f, 1)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0.2f, 1)), 
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.55f));

    // TODO(student): Draw the mesh that was created with `CreateMesh()`
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2.5f, 0.5f, 0.f), glm::vec3(0.55f)); // EXERCITIUL 

    // TODO(student): Draw the tetrahedron

    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(1, 0, 0), glm::vec3(1));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 1, 0), glm::vec3(1));
