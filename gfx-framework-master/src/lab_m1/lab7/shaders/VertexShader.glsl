...
void main()
{
    ...
    vec3 world_normal = normalize (vec3 (Model * vec4(v_normal, 0.0))); // trebuie normalizat
    ...
    float d = distance(eye_position, world_position);
    float attenuation_factor = 5 / (pow(d, 2));
