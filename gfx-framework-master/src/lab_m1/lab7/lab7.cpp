...
void Lab7::Init()
{
    ...
    {
        Mesh* mesh = new Mesh("tanque");
        mesh->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "tema2"), "TanqueF.fbx");
        meshes[mesh->GetMeshID()] = mesh;
    }
...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(21.0f / 255.0f, 32.0f / 255.0f, 166.0f / 255.0f));
    }
    ...
    // Render ground PLANE = PLAN NU AVION!!!!!!!!
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 0.01f, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.25f));
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(139.0f / 255.0f, 139.0f / 255.0f, 139.0f / 255.0f));
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        RenderSimpleMesh(meshes["tanque"], shaders["LabShader"], modelMatrix);
    }
