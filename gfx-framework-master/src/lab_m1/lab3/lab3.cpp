...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix *= transform2D::Translate(100 / 2.f, 100 / 2.f);
    ...
    int tx1 = 650 + 100 * sin(angularStep);
    int ty1 = 150 + 100 * cos(angularStep);
    ...
    scaleX = 1 + 0.5 * sin(angularStep);
    scaleY = 1 + 0.5 * sin(angularStep);
    ...
    modelMatrix = transform2D::Translate(150, 450);
    if (translateX < 1020) {
    ...
    modelMatrix *= transform2D::Translate(100 / 2.f, 100 / 2.f);
    modelMatrix *= transform2D::Rotate(angularStep * 1.f);
    modelMatrix *= transform2D::Translate(50 * 2.5f, 50 * 2.5f);
    modelMatrix *= transform2D::Translate(-100 / 2.f, -100 / 2.f);
