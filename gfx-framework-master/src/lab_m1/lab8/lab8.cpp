...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        secondLightPosition = glm::vec3(-1, 1, 0);
...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    point_light_pos[1] = secondLightPosition;
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_W)) {
            ...
            secondLightPosition -= forward * deltaTime * speed;

        }
        if (window->KeyHold(GLFW_KEY_A)) {
            lightPosition -= right * deltaTime * speed;
            secondLightPosition -= right * deltaTime * speed;
        ...
        if (window->KeyHold(GLFW_KEY_E)) {
            ...
            secondLightPosition += up * deltaTime * speed;
